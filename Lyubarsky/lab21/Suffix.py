...
def getParameters() :
    parser = argparse.ArgumentParser(description="This command writes the names and sizes of all executable files to the specified file.")
    parser.add_argument(
    '-s',
    type=str,
    default='',
...
def writeFile(_olddir : str, _fileSIze : int, _fileName : int):
    _root = os.getcwd()
    os.chdir(_olddir)
